...
with open('model/model_bio_modified22.yaml') as fin: model = model_from_yaml(fin.read())
...
flagY = []
flagZ = []
with open('pred_results/NERresult0517_bio_modified.txt' , 'w', encoding='utf-8') as fout:
